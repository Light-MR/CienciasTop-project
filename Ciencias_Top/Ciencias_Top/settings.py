"""
Django settings for Ciencias_Top project.
...
SECRET_KEY = 'django-insecure-m5x5b8_+n0_at+8@h#$)k@xku98(z2&3h#v12-&rphr1d=x)k%'
...
ROOT_URLCONF = 'Ciencias_Top.urls'
...
WSGI_APPLICATION = 'Ciencias_Top.wsgi.application'
